...
Initial Encounter ends when the score is 3.
...
Instead of auscultating:
	if PE is happening:
		play the sound of normal heartbeat;
	otherwise:
		say "Don't you think you should get her history first?"

Instead of examining [any person] eyes:
	if PE is happening:
		display the figure of Mildred's left fundus;
		display the figure of Mildred's right fundus;
		display the figure of Mildred's right eye;
	otherwise:
...
When Initial Encounter ends:
	say "Great, you got some initial information. Now get into greater detail".
...
[The following allows possessives to work].
